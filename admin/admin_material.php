      ...
      <div class="col-sm-12 text-left">
        ...
        <?php
          ...
          ?>
                ...
                <table class="table table-bordered">
                  ...
                  <?php
                      ...
                      while($obj = $result->fetch_object()) {
                          ...
                          echo "<td><a href='admin_material_borrar.php?id=$obj->id_material'><img src='../Imagenes/iconos/delete_16.png' width='13%';/></a>
                                <a href='admin_material_edit.php?id=$obj->id_material'><img src='../Imagenes/iconos/edit_16.png' width='13%';/></a></td>";
                          echo "</tr>";
              ...
              <div>
                <br>
                <p>Para <b>añadir nuevo material</b>, pulsar en el botón.</p>
                <a href='admin_material_add.php' class="btn btn-info"><img src='../Imagenes/iconos/add1_16.png';/> <font color="black">Añadir material</font></a>
                <br><br><br>
              </div>
      </div>
        <div class="row">
