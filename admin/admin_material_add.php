...
?>
      ...
      <?php
        ...
        echo "<span><b>Material:</b></span> <input type='text' name='nombre' value='$obj->nombre'\><br><br>";
        echo "<span><b>Fecha de compra:</b></span> <input type='date' name='fecha_compra' value='$obj->fecha_compra'\><br><br>";
