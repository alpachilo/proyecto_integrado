...
<html lang="">
  <head>
        ...
        <div class="container-fluid text-center">
          ...
          <div class="row content">
            ...
            <div class="col-sm-6 text-left">
              <h2>Editar listado de socios</h2>
              <hr>
                ...
                if (isset($_POST['edit'])) {
                  ...
                  //consulta
                  $consulta="UPDATE usuarios SET nombre='$nombre', fecha_naci='$fecha_naci', direccion='$direccion', ciudad='$ciudad', provincia='$provincia', codigo_postal=$codigo_postal, telefono=$telefono, email='$email' WHERE id_usuario=$id;";
    ...
    <div class="col-sm-6 text-left">
      <br>
      <img class="img-responsive img-rounded" style="margin: 0 auto;" src="../Imagenes/socios.jpg" alt="cursos" width="600" height="300">
      <br><br><br>
    </div>
