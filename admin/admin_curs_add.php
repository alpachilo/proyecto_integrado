...
<div class="container-fluid text-center">
  ...
  <div class="container-fluid text-center">
      ...
      <div class="col-sm-6 text-left">
        ...
        <hr>
          ...
          if (isset($_POST['enviar'])) {
            ...
            //consulta
            $consulta="INSERT INTO curso VALUES (null,'$nombre',$precio,'$fecha');";
          ...
          <?php
                ...
                echo "<span><b>Precio:</b></span> <input type='number' name='precio' value='$obj->precio'\><br><br>";
    ...
    <div class="col-sm-6 text-left">
      <img class="img-responsive img-rounded" style="margin: 0 auto;" src="../Imagenes/add_cursos.jpg" alt="cursos" width="500" height="200">
