        ...
        <div class="container-fluid text-center">
          ...
          <div class="row content">
            ...
            <div class="col-sm-6 text-left">
              <h2>Editar registro de salidas</h2>
              <hr>
                ...
                if ($result = $connection->query("SELECT * from registro_actividades
                  where id_registro = '$id';")) {

                  $obj = $result->fetch_object();

                  echo "<form method='post' id='formulario'>";
                  echo "<span><b>Fecha:</span></b> <input type='date' name='fecha' value='$obj->fecha'\><br><br>";
                  echo "<span><b>Hora:</span></b> <input type='time' name='hora' value='$obj->hora'\><br><br>";
                  echo "<span><b>Invitados</span></b> <input type='text' name='invitados' value='$obj->invitados'\><br><br>";
                ...
                if (isset($_POST['edit'])) {
                  ...
                  //consulta
                  $consulta="UPDATE  `registro_actividades` SET
                  `fecha` =  '$fecha',
                  `hora` =  '$hora',
                  `invitados` =  '$invitados'
                  WHERE  `id_registro` =$id;";
              ...
              <div class="col-sm-6 text-left">
                <br>
                <img class="img-responsive img-rounded" style="margin: 0 auto;" src="../Imagenes/salidas.jpg" alt="cursos" width="500" height="200">
                <br><br><br>
              </div>
